...
import 'package:tic_tac_toe/module/define_player_o.dart';

class DefinePlayerX extends StatelessWidget {
  var playerXController = TextEditingController();
                                    ...
                                    child: OutlinedButton(
                                      onPressed: () {
                                        if (fomKey.currentState!.validate()) {
                                          ...
                                          GameCubit.get(context).playerXName=playerXController.text;
                                        }
                                      },
                                      child: Row(
                                        mainAxisAlignment:
